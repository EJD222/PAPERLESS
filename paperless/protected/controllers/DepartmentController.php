...
class DepartmentController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update', 'delete', 'listDepartment'),
				'users'=>array('@'),
			),
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('admin','delete', 'listDepartment', 'deleteDepartment'),
	...
	{
		$listOfDepartments = Department::model()->findAll();

		$this->render('listDepartment',array(
	...
	public function actionDeleteDepartment($id)
	{
		...
		try 
		{
			...
			$transaction->commit();
			Yii::app()->user->setFlash('success', 'Department deleted successfully.');
			$this->redirect(array('/department/listDepartment')); 
		} 
		catch (Exception $e) 
		{
			$transaction->rollback();
			Yii::log('Error deleting department: ' . $e->getMessage(), CLogger::LEVEL_ERROR);
			Yii::app()->user->setFlash('error', 'An error occurred while deleting the department.');
			$this->redirect(array('/department/listDepartment')); 
		}

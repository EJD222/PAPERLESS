    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-info shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Positions
                        </div>
                        <div class="row no-gutters align-items-center">
                            <div class="col-auto">
                                <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?= $totalPositionCount ?></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-auto">
...
<div class="row">
    ...
    <div class="col-xl-6 mb-4">
        <div class="card shadow">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">About PAPERLESS</h6>
            </div>
            <div class="card-body">
                <p>
                    PAPERLESS (Public Administration Platform for Efficient Records and Local Electronic System Streamlined) 
                    is an efficient and user-friendly Content Management System designed for local government units (LGUs) 
                    to streamline their administrative processes and transition to a paperless environment. The application 
                    offers several key features, including a queuing system, document tracking, and record management.
                </p>

                <p>
                    The queuing system functionality allows users to obtain a queue number from a thermal printer, eliminating the 
                    need for physical queues. Users can submit their documents and have them scanned using a printer, which converts 
                    them into PDF formats. Each document is assigned a transaction number for easy tracking and record-keeping.
                </p>

                <p>
                    The document tracking feature enables users to monitor the status and history of their submitted documents. 
                    Similar to a package tracking system, users can view the entire journey of their files, including signatures, 
                    approvals, and any requests for additional information. This feature ensures transparency and provides users 
                    with real-time updates on the progress of their documents.
                </p>
                
                <p>
                    Record management is another essential aspect of PAPERLESS. The system securely stores all scanned documents 
                    in a database, ensuring their availability and accessibility. It also includes a Document Management System (DMS) 
                    that serves as a backup for documents in case the physical copies are lost. This feature enables easy search and 
                    retrieval of documents, enhancing efficiency and reducing administrative burden.
                </p>
                
                <p>
                    Overall, PAPERLESS offers LGUs a comprehensive solution for managing their administrative processes. With its 
                    queuing system, document tracking, and record management features, it simplifies and streamlines workflows, 
                    promotes transparency, and facilitates a smooth transition to a paperless environment.
                </p>
